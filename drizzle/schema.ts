...
export const responses = pgTable("responses", {
	...
	index("idx_responses_survey_id").using("btree", table.surveyId.asc().nullsLast().op("int4_ops")),
	foreignKey({
			columns: [table.surveyId],
			foreignColumns: [surveys.surveyId],
...
export const questionsMap = pgTable("questions_map", {
...
export const clinicalDepartmentDailyReport = pgTable("clinical_department_daily_report", {
	id: serial().primaryKey().notNull(),
	userCreated: uuid("user_created"),
...
export const dailyPatientReport = pgTable("daily_patient_report", {
	id: serial().primaryKey().notNull(),
	sort: integer(),
	userCreated: uuid("user_created"),
	dateCreated: timestamp("date_created", { withTimezone: true, mode: 'string' }),
...
export const omnisolMedicalAid = pgTable("omnisol_medical_aid", {
	id: serial().primaryKey().notNull(),
	visitId: varchar("visit_id", { length: 20 }).notNull(),
...
export const omnisolAdmissions = pgTable("omnisol_admissions", {
	id: serial().primaryKey().notNull(),
	visitId: varchar("visit_id", { length: 20 }).notNull(),
...
export const omnisolReferrals = pgTable("omnisol_referrals", {
	id: serial().primaryKey().notNull(),
	visitId: varchar("visit_id", { length: 20 }).notNull(),
...
export const omnisolPayments = pgTable("omnisol_payments", {
	id: serial().primaryKey().notNull(),
	visitId: varchar("visit_id", { length: 20 }).notNull(),
...
export const omnisolDiagnoses = pgTable("omnisol_diagnoses", {
	id: serial().primaryKey().notNull(),
	visitId: varchar("visit_id", { length: 20 }).notNull(),
